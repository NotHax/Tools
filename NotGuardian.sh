...
echo $red " $kuni [ 13 ] $r $g Edit Login Termux"
echo $red " $kuni [ 14 ] $r $g Spam WhatsApp"
echo $red " $kuni [ 15 ] $r $g CCTV Hack"
echo $red " $kuni [ 16 ] $r $g FBH"
echo $red " $kuni [ 17 ] $r $g Locator "
echo $red " $kuni [ 18 ] $r $g Take Data Target"
echo $red " $kuni [ 19 ] $r $g Hammer"
echo $red " $kuni [ 20 ] $r $g ShellPhish"
echo $red " $kuni [ 21 ] $r $g BlackEye"
echo $red " $kuni [ 22 ] $r $g Santet Online"
echo $red " $kuni [ 23 ] $r $g Report FB"
echo $red " $kuni [ 24 ] $r $g Trap Project"
echo $red " $kuni [ 25 ] $r $g Agony Project"
echo $red " $kuni [ 26 ] $r $g Light Bringer"
echo $red " $kuni [ 27 ] $r $g All Seeing"
echo $red " $kuni [ 28 ] $r $g Nmap Lite"
